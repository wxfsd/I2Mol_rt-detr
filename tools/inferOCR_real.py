...
if __name__ == '__main__':
    ...
    if args.resume==bmd or args.resume=='bmd':
        args.outcsv_filename=f'/home/jovyan/rt-detr/rt-detr/output_2025Real/output_charge_{datanme}_bmd.csv'
    elif  args.resume==tt or args.resume=='tt':
        args.outcsv_filename=f'/home/jovyan/rt-detr/rt-detr/output_2025Realtt/output_charge_{datanme}_tt.csv'

    if args.infer:
        args.csv_path =f"/home/jovyan/volume/samba_share/from_docker/data/work_space/ori/real/{datanme}.csv"
        args.image_dir  = f"/home/jovyan/volume/samba_share/from_docker/data/work_space/ori/real/{datanme}" 
        args.visual_check=False
        args.other2ppsocr=True
        args.getacc=True
