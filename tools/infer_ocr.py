...
if __name__ == '__main__':
    ...
    # args.outcsv_filename=f'/home/jovyan/rt-detr/rt-detr/output_2025/output_charge_{datanme}_bmd.csv'
    if args.infer:
        # args.csv_path =f"/home/jovyan/volume/samba_share/from_docker/data/work_space/ori/real/{datanme}.csv" #279
        # args.image_dir = f"/home/jovyan/volume/samba_share/from_docker/data/work_space/ori/real/{datanme}" #*smi 279、
        args.csv_path =f"/home/jovyan/volume/samba_share/from_docker/data/csv_deal/{datanme}.csv" #279
        args.image_dir = f"/home/jovyan/volume/samba_share/from_docker/data/work_space/{datanme}" #*smi 279、
